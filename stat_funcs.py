...
def equal_var_test(*args):
    """
    Проверяем распределения на гомогенность дисперсий с помощью теста Левина.
    Вывод результат теста: статистику и p-value и интерпретацию
    :return:
    """
    W, p_lev = st.levene(*args)
    print(
        f'Levene test for variances equality \n'
